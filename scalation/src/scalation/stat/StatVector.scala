...
class StatVector (dim: Int) extends VectorD (dim)
{
    ...
    /**:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
     * Implicitly Construct a StatVector from a VectorN [Double], i.e., VectorD
     * @param v  the vector to initialize StatVector
     */ 
    implicit def mkStatVector (v: VectorD) = new StatVector (v)
   ...
   /**:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    * Compute the covariance statistic between to StatVectors
    */
    def cov (rhs: StatVector) = (this*rhs).mean - this.mean * rhs.mean

   /**:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    * Compute the correlation statistic between two StatVectors
    */
