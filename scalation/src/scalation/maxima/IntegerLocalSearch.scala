...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** This class performs local search to find maxima of functions defined on
 *  integer vector domains (z^n).
 *
 *  minimize    f(x)
 *  subject to  g(x) <= 0, x in Z^n
 *
 *  @param f        the objective function to be maximize (f maps an integer vector to a double)
                          ...
                          maxStep: Int = 5)
{
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Find a maximal neighbor of the current point x that is a distance step away.
     ...
     */
    def maxNeighbor (x_f0: Vec_Func, i: Int, step: Int = 1): Vec_Func =
    {
        ...
        if (DEBUG) println ("maxNeighbor: candidates at i = " + i + ": " + x_f + ", " + y_f + ", " + z_f)

        if (i < x_f._1.dim - 1) {
            x_f = maxNeighbor (x_f, i + 1, step)   // min in neighborhood of x_f
            y_f = maxNeighbor (y_f, i + 1, step)   // min in neighborhood of y_f
            z_f = maxNeighbor (z_f, i + 1, step)   // min in neighborhood of z_f
        } // if

        if (x_f._2 > y_f._2) {               // find largest of 3 functional value
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Solve the maximization problem by repeatedly moving to a maximal
     *  neighbor until there is no improvment.
    ...
    def solve (x: VectorI): Vec_Func =
    {
        ...
        for (k <- 1 to maxIter) {
            ...
            val y_f = maxNeighbor (x_f, 0, step)
...
{
    import math.pow
    def f (x: VectorI): Double = -pow(x(0)-5,2) + 5 
    val x0  = new VectorI (1)
