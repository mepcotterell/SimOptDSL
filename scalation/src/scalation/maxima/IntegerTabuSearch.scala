...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** This class performs tabu search to find maxima of functions defined on
                         ...
                         maxStep: Int = 5)
{
    ...
    def maxNeighbor (x_f0: Vec_Func, i: Int, step: Int = 1): Vec_Func =
    {
        ...
        if (i < x_f._1.dim - 1) {
            x_f = maxNeighbor (x_f, i + 1, step)   // max in neighborhood of x_f
            y_f = maxNeighbor (y_f, i + 1, step)   // max in neighborhood of y_f
            z_f = maxNeighbor (z_f, i + 1, step)   // max in neighborhood of z_f
        } // if
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Solve the maximization problem by repeatedly moving to a maximal neighbor
